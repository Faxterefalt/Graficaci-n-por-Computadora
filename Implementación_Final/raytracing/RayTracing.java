...
import componentes.transformaciones.Vector3;
...
public class RayTracing {
     ...
     * @return color
     */
    public static Color render(Scene scene, Ray ray, Intersection closestIntersection, Color pixelColor, Luz light, Camera mainCamera, ArrayList<Object3D> objects, int rounds) {
